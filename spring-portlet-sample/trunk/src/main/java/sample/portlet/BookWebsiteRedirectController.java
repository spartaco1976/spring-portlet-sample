...
public class BookWebsiteRedirectController extends AbstractController {

	private BookService bookService;

	@Override
	public void handleActionRequestInternal(ActionRequest request, ActionResponse response) throws IOException {
